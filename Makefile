...
abs_builddir = /opt/workspace/hades/apps/coding/libcoap
top_builddir = .
...
SOURCES:= pdu.c net.c debug.c encode.c uri.c coap_list.c resource.c hashkey.c \
	 str.c option.c async.c subscribe.c block.c cJSON.c
...
HEADERS:=coap.h config.h debug.h pdu.h net.h encode.h uri.h coap_list.h mem.h \
	...
	subscribe.h block.h address.h prng.h coap_time.h t_list.h cJSON.h
